...
post.h <- list(
  ...
  r_s = inla.tmarginal(function(x) exp(x), 
                       fit102$internal.marginals.hyperpar[[2]]),
  r_t = inla.tmarginal(function(x) exp(x), 
                       fit102$internal.marginals.hyperpar[[3]]),
  sigma = inla.tmarginal(function(x) exp(x), 
