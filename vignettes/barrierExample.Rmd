...
This model specify a model over a spatial domain accounting for physical barriers. 
There is a implementation available in 
...
```{r bdomain}
barrier1 <- cbind(
  c(0.38, 0.42, 0.42, 0.38, 0.38) * rxy[1], 
  c(0.55, 0.55, 1.50, 1.50, 0.55) * rxy[2])
barrier2 <- cbind(
...
The visualized values of the simulated process in the barrier
allows a visual inspection to check if the simulated process 
follows the desired property.
The process in different sides of the barriers 
seen to be independent, 
if considering it far enough from the tips of the barriers, 
near the center of the domain.
This signs that the range in the barrier was set small enough.
